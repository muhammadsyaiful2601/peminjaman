...
## 5. Spesifikasi Arsitektur Teknologi
...
* **Frontend:** React.js, Tailwind CSS, Lucide React (Icons), HTML5 Camera API, QrCode / HTML5-Qrcode Library.
* **Backend:** Laravel (Laravel Sanctum untuk Autentikasi API / Inertia.js Adapter), Simple QrCode Package (BaconQrCode).
* **Database:** MySQL.
...
1. **Responsivitas UI:** Tampilan frontend harus sepenuhnya responsif (mobile & desktop) menggunakan Tailwind CSS.
2. **Keamanan:** 
   * Akses endpoint disesuaikan dengan role melalui middleware Laravel.
